...
| **Overall Neighborhood Score** | 4.2/10 | Moderate |
...
- Educational institutions are limited within 1km radius (2 schools found)
- Grocery options are limited — only 3 within 1km

## Specific Address Data: 1234 NW 23rd Avenue

Detailed walkability and amenity data for the specific address 1234 NW 23rd Avenue is available in [data/nob-hill-1234-nw-23rd-ave.json](data/nob-hill-1234-nw-23rd-ave.json).

## Data Files

| File | Description |
|------|-------------|
| [data/nob-hill-portland.json](data/nob-hill-portland.json) | General Nob Hill / Northwest District neighborhood data |
| [data/nob-hill-1234-nw-23rd-ave.json](data/nob-hill-1234-nw-23rd-ave.json) | Specific address data for 1234 NW 23rd Avenue |
